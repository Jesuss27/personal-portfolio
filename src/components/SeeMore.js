            ...
            <Row>
                <Col className='d-flex p-5 flex-column  justify-content-center align-items-center' lg={6}>
                    ...
                    <Button style={{
                        ...
                        minHeight:"48px",
                        minWidth:"250px"
                    }}><a href="https://github.com/Jesuss27" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="34.875" height="34.003" viewBox="0 0 34.875 34.003">
                ...
                <Col className='d-flex p-5  flex-column  justify-content-center align-items-center' lg={6}>
                    ...
                    <Button style={{
                        ...
                        color:"white"
                    }}><a href='https://codepen.io/jesuss27' target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
